...
import { Assignments, SearchResult } from '../models/assignment.models';
...
*/
function sort(tables: Assignments[], column: string, direction: string): Assignments[] {
  if (direction === '') {
    return tables;
  } else {
...
*/
function matches(tables: Assignments, term: string, pipe: PipeTransform) {
...
export class AssignmentsService {
  ...
  // tslint:disable-next-line: variable-name
  private _tables$ = new BehaviorSubject<Assignments[]>([]);
  // tslint:disable-next-line: variable-name
  ...
  private _search(): Observable<SearchResult> {
    ...
    let tables = new Array<Assignments>();
  ...
  public getAll() {
    ...
    this.http.get<any>(`${environment.apiUrl}/api/Assignments?Page=` + this.page
  ...
  public getById(id: number) {
    return this.http.get<any>(`${environment.apiUrl}/api/Assignments/` + id);
  }

  /**
   * Add item
   */
  public add(_assignments: Assignments) {
    //Map
    let title = _assignments.title;
    let dueDate = _assignments.dueDate;
   ...
   * Edit item
   */
  public edit(_assignments: Assignments) {
   ...
   */
  delete(id: number) {
    return this.http.delete<any>(`${environment.apiUrl}/api/Assignments/` + id);
  }
