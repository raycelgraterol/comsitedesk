...
import { HeadquarterModel, SearchResult } from '../models/headquarter.models';
...
*/
function sort(tables: HeadquarterModel[], column: string, direction: string): HeadquarterModel[] {
  if (direction === '') {
      return tables;
  } else {
...
*/
function matches(tables: HeadquarterModel, term: string, pipe: PipeTransform) {
...
export class HeadquarterService {
  ...
  // tslint:disable-next-line: variable-name
  private _tables$ = new BehaviorSubject<HeadquarterModel[]>([]);
  // tslint:disable-next-line: variable-name
  ...
  tableData: Array<HeadquarterModel>;
  ...
  private _search(): Observable<SearchResult> {
      ...
      let tables = new Array<HeadquarterModel>();
   ...
   */
  public getAll() {
      this.http.get<any>(`${environment.apiUrl}/api/Headquarter?Page=` + this.page
  ...
  public getById(id: number) {
      return this.http.get<any>(`${environment.apiUrl}/api/Headquarter/` + id);
  }

  /**
   * Add item
   */
  public add(_headquarterModel: HeadquarterModel) {
      //Map
   ...
   * Edit item
   */
  public edit(_headquarterModel: HeadquarterModel) {

      //Map
      let id = _headquarterModel.id;
      let name = _headquarterModel.name;
      let phoneNumber = _headquarterModel.phoneNumber;
      let address = _headquarterModel.address;
      let organizationsId = _headquarterModel.organizationsId;
  ...
  /**
    ...
    */
  getAllItems() {
      return this.http.get<any>(`${environment.apiUrl}/api/Headquarter/All`);
  }    
   ...
   */
  delete(id: number) {
      return this.http.delete<any>(`${environment.apiUrl}/api/Headquarter/` + id);
  }
