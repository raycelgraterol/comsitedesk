...
export class ProjectsService {
  ...
  public getAll() {
    ...
    this.http.get<any>(`${environment.apiUrl}/api/Projects?Page=` + this.page
  ...
  public add(_projects: ProjectModel) {
    //Map
    let title = _projects.title;
    let description = _projects.description;
    let startDate = _projects.startDate;
