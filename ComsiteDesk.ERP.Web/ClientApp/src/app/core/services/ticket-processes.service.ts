...
import { TicketProcesses, SearchResult } from '../models/ticket-processes.models';
...
*/
function sort(tables: TicketProcesses[], column: string, direction: string): TicketProcesses[] {
  if (direction === '') {
      return tables;
  } else {
...
*/
function matches(tables: TicketProcesses, term: string, pipe: PipeTransform) {
...
export class TicketProcessesService {
   ...
   // tslint:disable-next-line: variable-name
   private _tables$ = new BehaviorSubject<TicketProcesses[]>([]);
   // tslint:disable-next-line: variable-name
   ...
   tableData: Array<TicketProcesses>;
   item: TicketProcesses;
   ...
   private _search(): Observable<SearchResult> {
       ...
       let tables = new Array<TicketProcesses>();
    ...
    */
   public getAll() {
       this.http.get<any>(`${environment.apiUrl}/api/TicketProcesses?Page=` + this.page
   ...
   public getById(id: number) {
       return this.http.get<any>(`${environment.apiUrl}/api/TicketProcesses/` + id);
   }
    ...
    * Edit item
    */
   public edit(_ticketProcesses: TicketProcesses) {
    ...
    */
   delete(id: number) {
       return this.http.delete<any>(`${environment.apiUrl}/api/TicketProcesses/` + id);
   }
