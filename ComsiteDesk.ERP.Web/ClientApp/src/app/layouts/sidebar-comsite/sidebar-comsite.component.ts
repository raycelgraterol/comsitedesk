...
@Component({
  selector: 'app-sidebar-comsite',
  templateUrl: './sidebar-comsite.component.html',
  styleUrls: ['./sidebar-comsite.component.scss']
})
export class SidebarComsiteComponent implements OnInit {
