...
import { TicketProcesses, SearchResult, } from 'src/app/core/models/ticket-processes.models';
import { TicketProcessesService } from 'src/app/core/services/ticket-processes.service';

@Component({
  selector: 'app-ticket-processes',
  templateUrl: './ticket-processes.component.html',
  styleUrls: ['./ticket-processes.component.scss']
})
export class TicketProcessesComponent implements OnInit {

 // bread crum data
 breadCrumbItems: Array<{}>;

 // Table data
 tableData: TicketProcesses[];
 error = '';
 message = '';
 loading = false;
 submit: boolean;
 ...
 tables$: Observable<TicketProcesses[]>;
 total$: Observable<number>;
 item: TicketProcesses;
 @ViewChildren(AdvancedSortableDirective) headers: QueryList<AdvancedSortableDirective>;

 constructor(
   public service: TicketProcessesService,
 ...
 ngOnInit() {
   ...
   this.service.getAll();
   this.item = new TicketProcesses();

   // tslint:disable-next-line: max-line-length
   this.breadCrumbItems = [
     { label: 'Comsite', path: '/' },
     { label: 'Tipos de Tickets', path: '/', active: true }
   ];
     ...
     this.service.getById(Id)
       .subscribe(result => {
         if(result){
           ...
           this.innerform.controls.step.setValue(this.item.step);           
  ...
  */
  validSubmit() {
   ...
   this.item.step = this.form.step.value;
