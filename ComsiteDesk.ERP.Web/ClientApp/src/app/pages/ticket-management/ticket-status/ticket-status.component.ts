...
import { TicketStatus, SearchResult, } from 'src/app/core/models/ticket-status.models';
...
export class TicketStatusComponent implements OnInit {
  ...
  tables$: Observable<TicketStatus[]>;
  ...
  ngOnInit() {
    ...
    this.service.getAll();
    this.item = new TicketStatus();

    // tslint:disable-next-line: max-line-length
    this.breadCrumbItems = [
      { label: 'Comsite', path: '/' },
      { label: 'Estatus de Tickets', path: '/', active: true }
    ];
