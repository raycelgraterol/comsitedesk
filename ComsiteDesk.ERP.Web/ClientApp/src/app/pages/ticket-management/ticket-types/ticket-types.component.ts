...
import { TicketTypes, SearchResult, } from 'src/app/core/models/ticket-types.models';
...
export class TicketTypesComponent implements OnInit {
  ...
  tables$: Observable<TicketTypes[]>;
  total$: Observable<number>;
  item: TicketTypes;
  @ViewChildren(AdvancedSortableDirective) headers: QueryList<AdvancedSortableDirective>;

  constructor(
    public service: TicketTypesService,
